...
const Services = () => {
  return (
    ...
    >
      <div className="w-[1200px] h-[100%] absolute flex justify-center items-center max-lg:w-[750px] max-xl:w-[1000px] max-md:w-[100%]">
      ...
      <div className="w-full h-[70vh] flex flex-row justify-center bg-[#0a192f] max-md:h-[200vh]"></div>
    </div>
  );
};
